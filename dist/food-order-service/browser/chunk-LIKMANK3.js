...
var _c04 = () => ["name", "price"];
function AdminDashboardComponent_th_7_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminDashboardComponent_td_8_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminDashboardComponent_th_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 8);
    \u0275\u0275text(1, "Price");
    \u0275\u0275elementEnd();
...
function AdminDashboardComponent_td_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 9);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AdminDashboardComponent_tr_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 10);
  }
}
function AdminDashboardComponent_tr_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 11);
  }
}
function AdminDashboardComponent_div_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(o_r3.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate3(" - \u20B9", o_r3.total, " - ", o_r3.status, " - ", \u0275\u0275pipeBind2(4, 4, o_r3.placedAt, "short"), " ");
  }
}
var AdminDashboardComponent = class _AdminDashboardComponent {
  ...
  static \u0275fac = function AdminDashboardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminDashboardComponent)(\u0275\u0275directiveInject(ProductService), \u0275\u0275directiveInject(OrderService), \u0275\u0275directiveInject(FormBuilder));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminDashboardComponent, selectors: [["ng-component"]], standalone: false, decls: 18, vars: 6, consts: [["mat-table", "", 3, "dataSource"], ["matColumnDef", "name"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "price"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [4, "ngFor", "ngForOf"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function AdminDashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "h2");
      \u0275\u0275text(1, "Admin Dashboard");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(2, "section")(3, "h3");
      \u0275\u0275text(4, "Products");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "table", 0);
      \u0275\u0275elementContainerStart(6, 1);
      \u0275\u0275template(7, AdminDashboardComponent_th_7_Template, 2, 0, "th", 2)(8, AdminDashboardComponent_td_8_Template, 2, 1, "td", 3);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(9, 4);
      \u0275\u0275template(10, AdminDashboardComponent_th_10_Template, 2, 0, "th", 2)(11, AdminDashboardComponent_td_11_Template, 2, 1, "td", 3);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275template(12, AdminDashboardComponent_tr_12_Template, 1, 0, "tr", 5)(13, AdminDashboardComponent_tr_13_Template, 1, 0, "tr", 6);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "section")(15, "h3");
      \u0275\u0275text(16, "Orders");
      \u0275\u0275elementEnd();
      \u0275\u0275template(17, AdminDashboardComponent_div_17_Template, 5, 7, "div", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(7);
      \u0275\u0275property("matHeaderRowDef", \u0275\u0275pureFunction0(4, _c04));
      \u0275\u0275advance();
      \u0275\u0275property("matRowDefColumns", \u0275\u0275pureFunction0(5, _c04));
      \u0275\u0275advance(4);
      \u0275\u0275property("ngForOf", ctx.orders);
    }
  }, dependencies: [NgForOf, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, DatePipe], encapsulation: 2 });
};
(() => {
  ...
  }], () => [{ type: ProductService }, { type: OrderService }, { type: FormBuilder }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminDashboardComponent, { className: "AdminDashboardComponent", filePath: "src/app/features/admin/admin-dashboard/admin-dashboard.component.ts", lineNumber: 42 });
})();
...
//# sourceMappingURL=chunk-LIKMANK3.js.map
