...
function CartPageComponent_mat_list_3_mat_list_item_1_img_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 9);
  }
  if (rf & 2) {
    const i_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275propertyInterpolate("alt", i_r2.name);
    \u0275\u0275property("src", i_r2.image, \u0275\u0275sanitizeUrl);
  }
}
function CartPageComponent_mat_list_3_mat_list_item_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-list-item");
    \u0275\u0275template(1, CartPageComponent_mat_list_3_mat_list_item_1_img_1_Template, 1, 2, "img", 5);
    ...
    \u0275\u0275listener("click", function CartPageComponent_mat_list_3_mat_list_item_1_Template_button_click_7_listener() {
      const i_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.dec(i_r2));
    });
    \u0275\u0275text(8, "-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 7);
    \u0275\u0275listener("click", function CartPageComponent_mat_list_3_mat_list_item_1_Template_button_click_9_listener() {
      const i_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.inc(i_r2));
    });
    \u0275\u0275text(10, "+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 8);
    \u0275\u0275listener("click", function CartPageComponent_mat_list_3_mat_list_item_1_Template_button_click_11_listener() {
      const i_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", i_r2.image);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(i_r2.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("\u20B9", i_r2.price, " x ", i_r2.qty, "");
  }
}
function CartPageComponent_mat_list_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-list");
    \u0275\u0275template(1, CartPageComponent_mat_list_3_mat_list_item_1_Template, 13, 4, "mat-list-item", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var CartPageComponent = class _CartPageComponent {
  ...
  constructor(cart, router) {
    ...
    this.cart.items$.subscribe((_) => this.total = this.cart.getTotal());
  }
  inc(i) {
    this.cart.updateQty(i.productId, i.qty + 1);
  }
  dec(i) {
    this.cart.updateQty(i.productId, Math.max(0, i.qty - 1));
  }
  remove(i) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartPageComponent, selectors: [["app-cart-page"]], standalone: false, decls: 10, vars: 5, consts: [[4, "ngIf"], [1, "total"], [1, "actions"], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], [4, "ngFor", "ngForOf"], ["matListAvatar", "", 3, "src", "alt", 4, "ngIf"], ["matLine", ""], ["mat-mini-button", "", 3, "click"], ["mat-mini-button", "", "color", "warn", 3, "click"], ["matListAvatar", "", 3, "src", "alt"]], template: function CartPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div")(1, "h2");
      \u0275\u0275text(2, "Your Cart");
      \u0275\u0275elementEnd();
      \u0275\u0275template(3, CartPageComponent_mat_list_3_Template, 2, 1, "mat-list", 0);
      \u0275\u0275pipe(4, "async");
      \u0275\u0275elementStart(5, "div", 1);
      \u0275\u0275text(6);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "div", 2)(8, "button", 3);
      \u0275\u0275listener("click", function CartPageComponent_Template_button_click_8_listener() {
        return ctx.checkout();
      });
      \u0275\u0275text(9, "Checkout");
      \u0275\u0275elementEnd()()();
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(4, 3, ctx.items$));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" Total: \u20B9 ", ctx.total, " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.total === 0);
    }
  }, dependencies: [NgForOf, NgIf, MatButton, MatList, MatListItem, AsyncPipe], styles: ["\n\n.actions[_ngcontent-%COMP%] {\n  margin-top: 12px;\n}\n/*# sourceMappingURL=cart-page.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CartPageComponent, [{
    type: Component,
    args: [{ selector: "app-cart-page", standalone: false, template: `
    <div>
      <h2>Your Cart</h2>
      <mat-list *ngIf="(items$ | async) as items">
        <mat-list-item *ngFor="let i of items">
          <img matListAvatar [src]="i.image" *ngIf="i.image" alt="{{i.name}}">
          <div matLine>{{i.name}}</div>
          <div matLine>\u20B9{{i.price}} x {{i.qty}}</div>
          <div>
            <button mat-mini-button (click)="dec(i)">-</button>
            <button mat-mini-button (click)="inc(i)">+</button>
            <button mat-mini-button color="warn" (click)="remove(i)">Remove</button>
          </div>
        </mat-list-item>
      </mat-list>
      <div class="total">
      ...
      <div class="actions">
        <button mat-raised-button color="primary" (click)="checkout()" [disabled]="total===0">Checkout</button>
      </div>
    </div>
  `, styles: ["/* angular:styles/component:scss;55dee42d7ece0bf16263e6c3ab27a2aa68423dcadff1fc1d85f2abf95d4c9aee;C:/Users/mansi.tripathi/Desktop/Mansi POC/food-order-service/src/app/features/cart/cart-page/cart-page.component.ts */\n.actions {\n  margin-top: 12px;\n}\n/*# sourceMappingURL=cart-page.component.css.map */\n"] }]
  }], () => [{ type: CartService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CartPageComponent, { className: "CartPageComponent", filePath: "src/app/features/cart/cart-page/cart-page.component.ts", lineNumber: 48 });
})();

// src/app/features/cart/checkout-page/checkout-page.component.ts
function CheckoutPageComponent_mat_error_7_Template(rf, ctx) {
  if (rf & 1) {
...
var CheckoutPageComponent = class _CheckoutPageComponent {
  fb;
  cartService;
  orderService;
  router;
  ...
  //   // take snapshot
  //   const currentItems = (this.cart as any).itemsSubject?.value ?? [];
  //   const payload: Omit<Order, 'id'|'placedAt'|'status'> & { userId?: string } = {
  //   // const payload = {
  //     items: currentItems,
  //     total: this.total,
  //     address: this.f.value.address,
  //   // userId: this.authService.user?.id  // optionally if you have auth
  //   };
  //   this.order.place(payload).subscribe({
  //     next: () => {
  //       this.cart.clear();
  ...
  submit() {
    ...
    const currentItems = this.cartService.itemsSubject?.value ?? [];
    const payload = {
      items: currentItems,
      total: this.total,
      // address: this.f.value.address,
  ...
  static \u0275fac = function CheckoutPageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CheckoutPageComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(CartService), \u0275\u0275directiveInject(OrderService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CheckoutPageComponent, selectors: [["app-checkout-page"]], standalone: false, decls: 17, vars: 4, consts: [[3, "ngSubmit", "formGroup"], ["appearance", "fill", 1, "full"], ["matInput", "", "formControlName", "address"], [4, "ngIf"], ["matInput", "", "formControlName", "payment"], [1, "summary"], ["mat-raised-button", "", "color", "primary", "type", "submit", 3, "disabled"]], template: function CheckoutPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "h2");
      \u0275\u0275text(1, "Checkout");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(2, "form", 0);
      \u0275\u0275listener("ngSubmit", function CheckoutPageComponent_Template_form_ngSubmit_2_listener() {
        return ctx.submit();
      });
      \u0275\u0275elementStart(3, "mat-form-field", 1)(4, "mat-label");
      \u0275\u0275text(5, "Delivery address");
      \u0275\u0275elementEnd();
      \u0275\u0275element(6, "textarea", 2);
      \u0275\u0275template(7, CheckoutPageComponent_mat_error_7_Template, 2, 0, "mat-error", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "mat-form-field", 1)(9, "mat-label");
      \u0275\u0275text(10, "Payment note (mock)");
      \u0275\u0275elementEnd();
      \u0275\u0275element(11, "input", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "div", 5)(13, "div");
      \u0275\u0275text(14);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "button", 6);
      \u0275\u0275text(16, "Place Order");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275property("ngIf", ctx.f.controls.address.invalid);
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate1("Total: \u20B9", ctx.total, "");
      \u0275\u0275advance();
      \u0275\u0275property("disabled", ctx.f.invalid);
    }
  }, dependencies: [NgIf, MatButton, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, MatInput, MatFormField, MatLabel, MatError], styles: ["\n\n.full[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.summary[_ngcontent-%COMP%] {\n  margin: 12px 0;\n}\n/*# sourceMappingURL=checkout-page.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CheckoutPageComponent, [{
    type: Component,
    args: [{ selector: "app-checkout-page", standalone: false, template: `
    <h2>Checkout</h2>
    <form [formGroup]="f" (ngSubmit)="submit()">
      <mat-form-field appearance="fill" class="full">
        <mat-label>Delivery address</mat-label>
        <textarea matInput formControlName="address"></textarea>
        <mat-error *ngIf="f.controls.address.invalid">Address is required</mat-error>
      </mat-form-field>

      <mat-form-field appearance="fill" class="full">
        <mat-label>Payment note (mock)</mat-label>
      ...
      <button mat-raised-button color="primary" type="submit" [disabled]="f.invalid">Place Order</button>
    </form>
  `, styles: ["/* angular:styles/component:scss;65069ad664b1959c84987788b29b2a1a27fda5a8f308b75fc4c04d7052b6a252;C:/Users/mansi.tripathi/Desktop/Mansi POC/food-order-service/src/app/features/cart/checkout-page/checkout-page.component.ts */\n.full {\n  width: 100%;\n}\n.summary {\n  margin: 12px 0;\n}\n/*# sourceMappingURL=checkout-page.component.css.map */\n"] }]
  }], () => [{ type: FormBuilder }, { type: CartService }, { type: OrderService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CheckoutPageComponent, { className: "CheckoutPageComponent", filePath: "src/app/features/cart/checkout-page/checkout-page.component.ts", lineNumber: 47 });
})();
...
//# sourceMappingURL=chunk-MGFBWGWK.js.map
