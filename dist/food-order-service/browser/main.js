...
var AppComponent = class _AppComponent {
  ...
  constructor(cartService, authService) {
    ...
    this.cartCount$ = this.cartService.items$.pipe(map((items) => items.reduce((sum, i) => sum + i.qty, 0)));
  ...
  static \u0275fac = function AppComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(CartService), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: false, decls: 3, vars: 0, consts: [[1, "app-main"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  ...
  }], () => [{ type: CartService }, { type: AuthService }], null);
})();
(() => {
...
var routes = [
  { path: "", loadChildren: () => import("./chunk-KHWYOHDZ.js").then((m) => m.ShopModule) },
  { path: "cart", loadChildren: () => import("./chunk-MGFBWGWK.js").then((m) => m.CartModule) },
  { path: "auth", loadChildren: () => import("./chunk-FXGU4VJB.js").then((m) => m.AuthModule) },
  { path: "admin", loadChildren: () => import("./chunk-LIKMANK3.js").then((m) => m.AdminModule) },
  { path: "**", redirectTo: "" }
];
var AppRoutingModule = class _AppRoutingModule {
  ...
  static \u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forRoot(routes, { initialNavigation: "enabledBlocking" }), RouterModule] });
};
(() => {
